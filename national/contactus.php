...
<table>
 <tr><td><input style="height:30px;width:200px;border-radius:5px;margin-top:30px;text-align:center;line-height:30px" type="text" name="name" placeholder="Enter your name"></td></tr>
 <tr><td><input style="height:30px;width:200px;border-radius:5px;margin-top:30px;text-align:center;line-height:30px" type="email" name="email" placeholder="Enter email address"></td></tr>
 <tr><td><input style="height:30px;width:200px;border-radius:5px;margin-top:30px;text-align:center;line-height:30px" type="number" name="mobile" placeholder="Enter mobile no."></td></tr>
 <tr><td><textarea style="height:40px;width:200px;border-radius:5px;margin-top:30px;text-align:center;line-height:30px" name="message" placeholder="Type message"></textarea></td></tr>
 <tr><td><input style="height:30px;width:200px;border-radius:5px;margin-top:30px;text-align:center;line-height:30px" type="submit"/></td></tr>
</table>
</center>
</form>
</div>
<div id="midb">
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.6576353631644!2d81.01987351463463!3d26.85083958315431!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399be2faec154cff%3A0xf776385d80d526df!2sNational+Homeopathic+Medical+College!5e0!3m2!1sen!2sin!4v1533049025356" width="600" height="500" frameborder="0" style="border:1px solid;border-radius:10px;" allowfullscreen></iframe>
</div>
</div>
