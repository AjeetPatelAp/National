...
<html>
<head>
<link href="css/patientprofile.css" type="text/css" rel="stylesheet">
...
<div id="mid">
 <div id="mida">
 <div id="h1"><b>Patient Profile</b></div>
 <div id="diva">
 <div id="photo"><img src="images/patientpro.png" height="250px" width="250px" style="border-radius:100%"></div>
 ...
 <tr><td><h4>PIN</h4></td><td><?php echo $row['pin'];?></td></tr></table>
 </div></div>
 </div>
</div>
