...
<div id="mid">
 ...
 <h1 style="margin-left:150;margin-top:10px;color:#004040">Who you Are..??</h1></br>
 <select style="margin-left:220px;"name="a">
 <option value="">--select--</option>
 <option  value="doctor">DOCTOR </option>
 <option  value="patient">PATIENT</option></select></br></br>
 <table>
 <tr><th></th><td><input class="button" style="margin-left:180px;height:40px;line-height:30px;text-align:center;color:#004040" placeholder="Enter your email address" type="text" name="email"></td></tr>
 <tr><th></th><td><input class="button" style="margin-left:180px;height:40px;margin-top:20px;line-height:30px;text-align:center;color:#004040" placeholder="Enter your email address" type="text" name="mobile"></td></tr>
 <tr><td></td><td><input type="submit" value="send" style="margin-left:180px;width:180px;height:40px;line-height:30px;margin-top:20px;text-align:center;background-color:#004040;color:white;" placeholder="Enter your mobile number" /></td></tr>
 </table>
 </form>
  </div>
</div>
