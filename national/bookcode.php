...
<div id="mid">
 ...
 <div id="diva">
 <div id="photo"><img src="upload/<?php echo $row['photo'];?>" style="border-radius:100%;width:260px;height:260px;"></div>
 ...
 <tr><td></td><td><input type="submit" value="Book appoiment" style="width:200px;height:30px;background-color:#008080;color:white;border-radius:10px"/></td></tr>
 </div></div>
 </div>
</div>
</div>
