...
<div id="headera1"><a href="team"><b>Team</b></a></div></div>
<div id="head1">
<div id="heada">
...
<tr><td class="td">Fname</td><td><input class="ab" type="text" name="fname"></td></tr>
...
<tr><td class="td">Upload file</td><td><input class="abc" type="file" name="file"></td></tr>
<tr><td class="td">Qualification</td><td>
<input type="radio" name="q" value="phd">PHD
<input type="radio" name="q" value="mbbs">MBBS
<input type="radio" name="q" value="msc">MSC
</td></tr>
<tr><td class="td">Mobile</td><td><input class="ab" type="number" name="mobile"></td></tr>
<tr><td class="td">Specialist</td><td>
<select name="spe" class="ab">
...
<tr><td class="td">Fees</td><td><input class="ab" type="number" name="fees"></td></tr>
<tr><td class="td">Timing</td><td><input class="ab" type="time" name="timing"></td></tr>
<tr><td class="td"></td><td><input class="ab" type="submit"/></td></tr>
</table>
</form>
</center>
</div>
