...
$query2="select * from tbl_doctor where email='$email'";
...
<ul>
	  ...
	  <li><a href="update.php?id=<?php echo $row2['0'];?>"><b>Update Profile</b></a>
	  </li>
...
<div id="divx">
<center>
<h1 style="color:#008080;font-family:albertus;margin-top:50px">Discussion Board</h1>
<form action="question.php" method="post">
<textarea name="ques" placeholder="Add Question"style="height:50px; width:200px;border-radius:5px;margin-top:10px;text-align:center;line-height:40px"></textarea></br>
<input type="submit" value="ADD" style="width:200px;height:30px;border-radius:8px;background-color:#008080;color:white;margin-top:10px;"/>
</form> 
</center>
</div>

<div id="divy">
<table border="2px solid #004040" align="center" style="border-radius:5px;box-shadow:5px 5px 25px #004040">
<tr><th class="th">S. No.</th>
<th class="th">Question</th>
<th class="th">Post Answer</th>
<th class="th">View Ansswer</th></tr>
<?php
$a=1;
...
<td class="td"><a href="post.php?qid=<?php echo $row['0'];?>">Post</a></td>
<td class="td"><a href="view.php?qid=<?php echo $row['0'];?>">View</a></td>
</tr>
<?php
$a++;
}
