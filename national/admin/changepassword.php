...
<table>
<tr><td><input type="text" name="op" placeholder="Old  password" style="border-radius:10px; margin-top:30px; text-align:center; width:300px; height:30px;"></td></tr>
<tr><td><input type="text" name="np" placeholder="New password" style="border-radius:10px; margin-top:30px; text-align:center; width:300px; height:30px;"></td></tr>
<tr><td><input type="text" name="cnp" placeholder="Confirm  new password" style="border-radius:10px; margin-top:30px; text-align:center; width:300px; height:30px;"></td></tr>
<tr><td><input type="submit" value="change" style="border-radius:10px; color:white;margin-top:20px; text-align:center; width:300px; height:30px;background-color:#008080"></td></tr>
</table>
</form>
</div>
</center>
