...
<textarea name="ans" placeholder="Enter answer" style="margin-top:50px; width:200px;height:80px;text-align:center;line-height:70px;border-radius:5px; font-size:25px"></textarea></br>
<input type="submit" value="Post answer" style="width:200px;height:40px;border-radius:5px;background-color:#008080;color:white;margin-top:10px"/>
</center>
</form>
</div>
</div>
