...
$email=$_SESSION['patient'];
$query2="select * from tbl_patient where email='$email' ";
...
<html>
<head>
<link href="css/book_app.css" type="text/css" rel="stylesheet">
...
<div id="mid">
<center>
<form action="book_appcode.php" method="post">
<img src="images/doctor.png" height="150px" width="150px">
<Select id="select" name="spe">
<option  id="option" value="">Select Speciality</option>
<?php
