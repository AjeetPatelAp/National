...
<form action="logcode.php" method="post">
 ...
 <div id="mid">
 <h1>LOGIN HERE !!</h1></br>
 <h3>Who you Are..??</h3></br>
 <select name="a" style="margin-right:30px">
 <option value="">--select--</option>
 <option  value="doctor">DOCTOR </option>
 <option  value="patient">PATIENT</option></select></br></br>
 <table>
 <tr><th></th><td><input class="button" type="text" name="email" style="background-color:#f5f5f5;text-align:center;" placeholder="Enter your email"></td></tr>
 <tr><th></th><td><input class="button" type="password" name="password" style="background-color:#f5f5f5;text-align:center;"placeholder="Enter your password"></td></tr>
 <tr><td></td><td><input class="button" type="submit" value="login" style="background-color:#008080;color:white;"/></td></tr>
 <tr><td></td><td><a href="forgot.php" >Forgot Password</a></td></tr>
 <tr><td></td><td>
  <?php
   if($msg==1)
   {
	   echo "Ivalid user or password";
   }
 ?>
 </td></tr>
 </table>
