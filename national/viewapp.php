...
$query2="select * from tbl_appoiment where doctor_id='$did'";
$res2=mysql_query($query2);
?>
<html>
<head>
<link href="css/viewapp.css" type="text/css" rel="stylesheet">
...
<div id="head2">
<ul>
      <li><a href="doctorprofile.php"><b>Home</a></b></li>
	  </li>
...
<div id="mida">
<center>
<h1 style="margin-top:40px; font-family:albertus;color:#006c6c">All appointments</h1>
...
<tr>
	...
	<td class="td"><?php
	$did=$row2['patient_id']; 
	$query3="select * from tbl_patient where patient_id='$did'";
	...
	?></td>
	<td class="td"><a href="statusd.php?sid=<?php echo $row2['0']?>"><?php echo $row2['status']; ?></a></td>
