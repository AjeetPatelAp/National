...
$query="select * from tbl_doctor where specialist='$spe'";
$res=mysql_query($query);

?>
<html>
<head>
<link href="css/book_appcode.css" type="text/css" rel="stylesheet">
...
<ul>
	  ...
	  <li><a href="update.php?id=<?php
        $query2="select * from tbl_doctor where specialist='$spe'";
...
<div id="mid">
<center>
<h1 style="font-family:albertus;margin-top:40px">
<?php
 echo "All $spe" ;
echo "'s";
?>
...
?>
	...
	<td><img src="upload/<?php echo $row['photo'] ?>" height="150px" width="150px"/></td>
	<td><a href="bookcode.php?id=<?php echo $row['0'];?>">Book</a></td>
	</tr>
<?php
$a++;
}
